            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" imageURL="resources/logobg.jpg" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        <webuijsf:label id="label1" style="height: 24px; left: 72px; top: 96px; position: absolute; width: 384px" text="Name Of The Game!!"/>
                        <webuijsf:label id="label2" style="height: 24px; left: 72px; top: 144px; position: absolute; width: 384px" text="You are currently in Step #n"/>
                        ...
                        <webuijsf:textArea columns="64" id="textArea1" rows="6" style="height: 96px; left: 72px; top: 240px; position: absolute; width: 408px"/>
